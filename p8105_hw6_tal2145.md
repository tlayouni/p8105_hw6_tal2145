...
```
    ...
    ## # A tibble: 1 x 5
    ##   mean_r2   sd_r2    error CI_lower CI_upper
    ##     <dbl>   <dbl>    <dbl>    <dbl>    <dbl>
    ## 1   0.912 0.00846 0.000235    0.911    0.912
...
```
    ...
    ## # A tibble: 1 x 5
    ##   mean_betas sd_betas error_betas CI_lower CI_upper
    ##        <dbl>    <dbl>       <dbl>    <dbl>    <dbl>
    ## 1       2.01   0.0237    0.000656     2.01     2.01
